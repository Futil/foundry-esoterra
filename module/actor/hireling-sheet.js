 ...
 * @extends {ActorSheet}
 */
export class EsoterraHirelingSheet extends ActorSheet {

  /** @override */
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["esoterra", "sheet", "actor", "hireling"],
      template: "systems/esoterra/templates/actor/hireling-sheet.html",
      width: 680,
      height: 620,
  ...
  getData() {
    ...
    // data.data.settings.useCalm = game.settings.get("esoterra", "useCalm");
    // data.data.settings.hideWeight = game.settings.get("esoterra", "hideWeight");
