 ...
 * @extends {ActorSheet}
 */
export class EsoterraStorageSheet extends ActorSheet {

    /** @override */
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            classes: ["esoterra", "sheet", "actor", "storage"],
            template: "systems/esoterra/templates/actor/storage-sheet.html",
            width: 475,
            height: 500,
            resizable: false,
    ...
    getData() {
        ...
        // Prepare items.
        if (this.actor.data.type == 'storage') {
